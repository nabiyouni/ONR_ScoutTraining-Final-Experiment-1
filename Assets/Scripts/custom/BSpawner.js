...
public var beacons : List.<GameObject> = new List.<GameObject>();
public var targets : List.<GameObject> = new List.<GameObject>();
...
*/
function instantiateBeacons_old() {
	var debugger:Logger = gameObject.Find("CAVE Mono").GetComponent(Logger);
...
*/
function destroyAllBeacons_old() {
